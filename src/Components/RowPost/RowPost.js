    ...
    <div className='row'>
        ...
        <div className="posters">
          {movies.map((obj)=>(
            ...
            <p className='movieName'>{obj.name}</p> {/* for netflix originals*/}
            <p className='movieName'>{obj.title}</p>{/* for balance all genere */}
            </div>
          ...
          { urlId &&  <YouTube opts={opts} videoId={urlId.key} />} {/*key is the field name of videoId */}
    </div>
  )
}
